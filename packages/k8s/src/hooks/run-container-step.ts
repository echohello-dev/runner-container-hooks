...
/**
 * Runs a container step.
 *
 * @param stepContainer The container step to run.
 * @returns A promise that resolves when the container step is done.
 */
...
/**
 * Creates a container spec for a container step.
 *
 * @example ```typescript
 * const container = createContainerSpec({ image: 'ubuntu:latest' }, 'secret-name')
 * ```
 * @param container The container step to create the spec for.
 * @param secretName The name of the secret to use for the container step.
 * @param extension The extension to use for the container step.
 * @returns A container spec for a container step.
 */
